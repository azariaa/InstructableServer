...
public class TestWithParser
{
    ...
    private static void runTest() throws Exception
    {
        ...
        IAllUserActions allUserActions = new TopDMAllActions("you@myworkplace.com", userId, new CommandsToParser(parserSettings, Optional.empty()), (executionStatus, subject, body, copyList, recipientList) -> {}, false, Optional.empty(), Optional.empty(), false);
...
//        actionResponse = allUserActions.end(new InfoForCommand(userSays, null));
    ...
    static class TestSimplifier
    {
        ...
        {
            testHelpers.userSays(userSays);
            CcgUtils.SayAndExpression response = parserSettings.parseAndEval(allUserActions, userSays, Optional.empty());
            testHelpers.systemSays(response.sayToUser);
        }
