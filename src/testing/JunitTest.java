...
public class JunitTest {
  ...
  public void testLongSentence1() {
    IAllUserActions allUserActions = new TopDMAllActions("you@myworkplace.com", "tempUser", new CommandsToParser(parserSettings, Optional.empty()), (executionStatus, subject, body, copyList, recipientList) -> {}, false, Optional.empty(), Optional.empty(), false);
