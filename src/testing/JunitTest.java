...
public class JunitTest {
  ...
  public void testLongSentence1() {
    IAllUserActions allUserActions = new TopDMAllActions("you@myworkplace.com", "tempUser", new CommandsToParser(parserSettings), (subject, body, copyList, recipientList) -> {}, false);
